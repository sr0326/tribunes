;(function () {
  ...
  // css_link ="./css/pub-footer.css"
  document.write('<link rel="stylesheet" type="text/css" href="' + css_link+'" />');
  var bottom_public_footer = '<div class="bottom-pub-footer footer-box pub_fo"><div class="pub-footer-new">\
    <div class="contact-box" id="pub-fo-contact-box">\
    </div>\
    <div id="pub-footerall">\
        ...
        <span style="font-weight:300">经营性网站备案信息</span>\
  ...
  document.write(bottom_public_footer);
  ...
  function changeImg(){
    ...
    if(storage.getItem('randomN') === '0'){
      newItem += '<div class="img-box"><a href="https://blog.csdn.net/csdnnews?utm_source=csdn_footer"  target="_blank"><img src="//csdnimg.cn/pubfooter/images/csdn-zx.png" alt="CSDN资讯"></a><p class="app-text">CSDN资讯</p></div><div class="img-box"><a href="https://edu.csdn.net?utm_source=csdn_footer" target="_blank"><img src="https://csdnimg.cn/pubfooter/images/edu-QR.png" alt="CSDN学院"></a><p class="app-text">CSDN学院</p></div><div class="img-box last"><img src="https://csdnimg.cn/pubfooter/images/job-QR.png" alt="CSDN企业招聘" style="padding:8px;border-radius: 4px;border: 1px solid #ebebeb;box-sizing: content-box;"></a><p class="app-text">CSDN企业招聘</p></div>'
      storage.setItem("randomN", '1');
    }else if(storage.getItem('randomN') === '1' || storage.getItem('randomN') === '2'){
      newItem += '<div class="img-box" ><a href="https://www.csdn.net/app/?utm_source=csdn_footer" target="_blank"><img  src="https://csdnimg.cn/pubfooter/images/app.png" alt="下载CSDN APP"></a><p class="app-text">下载CSDN APP</p></div><div class="img-box"><img src="https://csdnimg.cn/pubfooter/images/csdn-cxrs.png" alt="程序人生" style="padding:8px;border-radius: 4px;border: 1px solid #ebebeb;box-sizing: content-box;"><p class="app-text">程序人生</p></div><div class="img-box last"><a href="https://blog.csdn.net/csdnnews?utm_source=csdn_footer"  target="_blank"><img src="//csdnimg.cn/pubfooter/images/csdn-zx.png" alt="CSDN资讯"></a><p class="app-text">CSDN资讯</p></div>'
      storage.setItem("randomN", '0');
    }
    $(document).find('#pub-fo-contact-box').html(newItem)
  }
